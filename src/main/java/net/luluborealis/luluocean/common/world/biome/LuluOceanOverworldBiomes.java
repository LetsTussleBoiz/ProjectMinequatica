...
public class LuluOceanOverworldBiomes {
    ...
    public static Biome deadSea(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
        ...
        LuluOceanDefaultBiomeFeatures.addDeadSeaSpires(generationSettings);
    ...
    public static Biome lushStacks(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
        ...
        LuluOceanDefaultBiomeFeatures.addlushStacksSpires(generationSettings);
    ...
    public static Biome frozenDepths(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
        ...
        return new Biome.BiomeBuilder().hasPrecipitation(true).temperature(-1).temperatureAdjustment(Biome.TemperatureModifier.FROZEN).downfall(0.5F).specialEffects((new BiomeSpecialEffects.Builder()).waterColor(2688129).waterFogColor(787503).fogColor(12638463).skyColor(8103167).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build()).mobSpawnSettings(spawnSettings.build()).generationSettings(generationSettings.build()).build();
    }
