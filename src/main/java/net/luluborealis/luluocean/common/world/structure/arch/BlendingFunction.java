...
import net.luluborealis.luluocean.core.CorgiLibRegistry;
...
public interface BlendingFunction {
    Codec<BlendingFunction> CODEC = ExtraCodecs.lazyInitializedCodec(() -> CorgiLibRegistry.BLENDING_FUNCTION.get().getCodec().dispatchStable(BlendingFunction::codec, Function.identity()));
    DeferredRegister<Codec<? extends BlendingFunction>> PROVIDER = DeferredRegister.create(CorgiLibRegistry.BLENDING_FUNCTION_RESOURCE_KEY, LuluOcean.MOD_ID);
