package net.luluborealis.luluocean.common.world;
...
public final class LevelBiomeTracker {
    ...
    public static LevelBiomeTracker fromServer(MinecraftServer server) {
        ...
        for (ServerLevel level : server.getAllLevels()) {
            ...
            level.getChunkSource().getGenerator().getBiomeSource().possibleBiomes().stream().filter(biomeHolder -> biomeHolder.unwrapKey().orElseThrow().location().getNamespace().equals(LuluOcean.MOD_ID)).forEach(possibleBiome -> {
