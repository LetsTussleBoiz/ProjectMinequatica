...
public class BYGBiomeTags {
    ...
    public static final Supplier<Map<TagKey<Biome>, Set<TagKey<Biome>>>> BYG_BIOME_TAGS_TO_TAGS = Suppliers.memoize(() -> {
        ...
        map.put(IS_OCEAN, Set.of(BiomeTags.IS_OCEAN));
        map.put(IS_DEEP_OCEAN, Set.of(BiomeTags.IS_DEEP_OCEAN));
        ...
        map.put(ONLY_ALLOWS_SNOW_AND_GOLD_RABBITS, Set.of(BiomeTags.SPAWNS_WHITE_RABBITS, BiomeTags.SPAWNS_GOLD_RABBITS));
        ...
        map.put(CLIMATE_HOT_OVERWORLD, Set.of(ModLoaderBiomeTags.Forge.IS_HOT_OVERWORLD));
        map.put(CLIMATE_COLD_OVERWORLD, Set.of(ModLoaderBiomeTags.Forge.IS_COLD_OVERWORLD));
        map.put(CLIMATE_WET_OVERWORLD, Set.of(ModLoaderBiomeTags.Forge.IS_WET_OVERWORLD));
        map.put(CLIMATE_DRY_OVERWORLD, Set.of(ModLoaderBiomeTags.Forge.IS_DRY_OVERWORLD));
        ...
        map.put(IS_VEGETATION_SPARSE_OVERWORLD, Set.of(ModLoaderBiomeTags.Forge.IS_SPARSE_OVERWORLD));
        ...
        map.put(IS_VEGETATION_DENSE_OVERWORLD, Set.of(ModLoaderBiomeTags.Forge.IS_DENSE_OVERWORLD));
        ...
        map.put(IS_SNOWY, Set.of(ModLoaderBiomeTags.Forge.IS_SNOWY));
        map.put(IS_SPOOKY, Set.of(ModLoaderBiomeTags.Forge.IS_SPOOKY));
        map.put(IS_WASTELAND, Set.of(ModLoaderBiomeTags.Forge.IS_WASTELAND));
        map.put(IS_DEAD, Set.of(ModLoaderBiomeTags.Forge.IS_DEAD));
