...
package net.luluborealis.luluocean.particle.options;
...
public class FloatingSculkBubbleParticleOptions implements ParticleOptions {
	...
	public static final Deserializer<FloatingSculkBubbleParticleOptions> DESERIALIZER = new Deserializer<>() {
		@NotNull
		@Override
	...
	public ParticleType<?> getType() {
		return RegisterParticles.FLOATING_SCULK_BUBBLE.get();
	}
